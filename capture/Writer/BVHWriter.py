...
def Write(file, skeleton: list, timesamples: dict, *, framesPerSecond=60, decomposeAxises=SkelNode.ZXY):
    ...
    with open(baseDir / "main.bvh", "w") as f:
        ...
        motion(f, timesamples, decomposeAxises, secondsPerFrame=1.0 / framesPerSecond)
